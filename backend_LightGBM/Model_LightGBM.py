...
data_path = "D:/CSUD/backend/PhiUSIIL_Phishing_URL_Dataset.csv"  # Cập nhật đường dẫn nếu cần
...
# Lưu mô hình
joblib.dump(best_model, "D:/CSUD/backend_LightGBM/phishing_LightGBM.pkl")
print("Mô hình LightGBM đã được lưu vào 'phishing_LightGBM.pkl'")